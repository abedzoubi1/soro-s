...
import vertexShaderSource from "./node.square.vert.glsl";
import fragmentShaderSource from "./node.square.frag.glsl";
import { AbstractProgram } from "sigma/rendering/webgl/programs/common/program";
...
export class NodeProgramSquare extends AbstractProgram {
